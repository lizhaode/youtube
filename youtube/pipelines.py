...
class YoutubePipeline:
    def process_item(self, item: YoutubeItem, spider: Youtuber):
        ...
        prepare_command = f'yt-dlp --embed-subs --sub-langs "zh-CN,en" --embed-metadata --extractor-args "youtube:lang=zh-CN" -P {path} -o "{video_title}.%(ext)s" https://www.youtube.com/watch?v={video_id}'
